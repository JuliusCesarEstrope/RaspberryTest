...
public class Pi {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        final GpioPinDigitalInput pin2 = gpio.provisionDigitalInputPin(RaspiPin.GPIO_02, "TACH00");
        final GpioPinDigitalInput pin3 = gpio.provisionDigitalInputPin(RaspiPin.GPIO_03, "TACH01");
